...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './department-master.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPARTMENTMASTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPARTMENTMASTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPARTMENTMASTER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_DEPARTMENTMASTER actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_DEPARTMENTMASTER actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DEPARTMENTMASTER actions', async () => {
      const arg = 42666;
