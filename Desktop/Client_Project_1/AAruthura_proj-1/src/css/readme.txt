...
.home-logoTxt {
  margin-bottom: 0.5rem; /* Changed to rem */
  margin-left: 1rem; /* Changed to rem */
}
...
.home-main-nav {
  ...
  height: 9rem;
  display: grid;
  font-size: 1.7rem; /* Changed to rem for scalability */
...
.home-main-nav {
  ...
  /* Combined media queries for better readability */
  @media (max-width: 1080px) {
    .home-main-nav {
      height: 8rem;
      grid-template-columns: 2rem 3fr 3fr 1fr 2rem;
  ...
  @media (max-width: 998px) {
    ...
    .home-mobile-menu-overlay .close-btn {
      position: absolute;
      top: 4rem;
      left: 2rem;
      background: none;
    ...
    .home-mobile-menu-overlay ul {
      list-style-type:none;
      padding: 1;
      font-size: 20vh;
    }
  
    .home-mobile-menu-overlay ul li {
      margin: 5rem 0;
      font-size: 3rem;
      right: 1vh;
    ...
    .home-mobile-menu-overlay ul li a {
      color: black;
...
@media only screen and (max-width: 414px) {
  .infinity-trans12 {
      ...
      width: 100vw;
      border-radius: 0; /* Remove border-radius for smaller screens if needed */
...
@media (max-width: 768px) {
  ...
  @media only screen and (min-width: 600px)  {
    /* Your CSS code for small screens goes here */
    .homecom3 {
